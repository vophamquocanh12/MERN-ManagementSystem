...
const AdminSidebar = () => {
  const navItems = [
    ...
    { label: "Employees", icon: <FaUsers />, to: "/admin-dashboard/employees" },
    { label: "Departments", icon: <FaBuilding />, to: "/admin-dashboard/departments" },
    { label: "Leave", icon: <FaCalendarAlt />, to: "/admin-dashboard/leaves" },
    { label: "Salary", icon: <FaMoneyBillWave />, to: "/admin-dashboard/salary" },
  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-64 bg-gray-800 text-white flex flex-col py-4 space-y-6">
      <h2 className="text-2xl font-bold text-center">Employee MS</h2>
